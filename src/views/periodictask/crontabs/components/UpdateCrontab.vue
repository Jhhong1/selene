    ...
    <div>
        ...
        <el-form :model="periodictask" ref="periodictask" class="case-form">
            ...
            <el-form-item label="任务" :label-width="formLabelWidth" prop="testtask">
                <el-select v-model="periodictask.testtask" placeholder="请选择" class="method-class" size="mini">
            ...
            <el-form-item label="标签" :label-width="formLabelWidth" prop="tags">
                <el-select v-model="periodictask.tags" placeholder="请选择" size="mini" class="method-class">
            ...
            <el-form-item label="规则" :label-width="formLabelWidth" prop="crontab">
                <el-select v-model="periodictask.crontab" class="method-class" size="mini" filterable>
                    <el-option
