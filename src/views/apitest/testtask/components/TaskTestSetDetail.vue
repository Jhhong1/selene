...
export default {
  ...
  methods: {
    ...
    taskSetDetail () {
      let _this = this
      this.$api.api.taskTestSetDetail(_this.setId, _this.taskName, _this.projectName).then(
        (response) => {
    ...
    taskSetCases () {
      let _this = this
      this.$api.api.taskSetCases(_this.taskName, _this.setId, _this.projectName).then(
        (response) => {
