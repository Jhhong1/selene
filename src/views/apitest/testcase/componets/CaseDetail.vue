             ...
             <div>
               <el-row :gutter="10" class="row-class">
                 ...
                 <template v-if="cases.name">
                   <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">{{ cases.name }}</el-col>
                 </template>
                 <template v-else>
               ...
               <template v-if="cases.caserelationship">
                 <el-row :gutter="10" class="row-class">
                   <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">状态</el-col>
                   ...
                   <template v-if="cases.updateTime">
                     <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">{{ cases.updateTime }}</el-col>
                   </template>
                   <template v-else>
                     <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">-</el-col>
                   </template>
                 ...
                 <el-row :gutter="10" class="row-class">
                   ...
                   <template v-if="cases.caserelationship.startRunTime">
                     <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">{{cases.caserelationship.startRunTime}}</el-col>
                   </template>
                   <template v-else>
                     <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">-</el-col>
                   </template>
                 ...
                 <el-row :gutter="10" class="row-class">
                   ...
                   <template v-if="cases.caserelationship.endRunTime">
                     <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">{{cases.caserelationship.endRunTime}}</el-col>
                   </template>
                   <template v-else>
                     <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">-</el-col>
                   </template>
                   ...
                   <template v-if="cases.caserelationship.errorMessage">
                     <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11" class="test-right">
                       <el-tooltip placement="top-start">
                         ...
                         <el-button type="text" size="mini" plain class="el-button__text is-plain">{{cases.caserelationship.errorMessage}}</el-button>
                       </el-tooltip>
                     </el-col>
                   </template>
                   <template v-else>
           ...
           <el-card>
             <div>
               <el-row :gutter="10" class="row-class">
                 ...
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">{{ cases.url }}</el-col>
               </el-row>
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">请求方法</el-col>
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">{{ cases.method}}</el-col>
               </el-row>
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">变量</el-col>
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">
                    <input-counter v-model="cases.variables" :edit="false"></input-counter>
                 </el-col>
               </el-row>
               <el-row :gutter="10" class="row-class">
               ...
               <el-row :gutter="10" class="row-class">
                 ...
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">
                   <input-counter v-model="cases.headers" :edit="false"></input-counter>
                 </el-col>
               </el-row>
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">请求内容</el-col>
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">
                   <vue-json-editor v-model="cases.body" :edit="false"></vue-json-editor>
                 </el-col>
               </el-row>
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">结果断言</el-col>
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">
                   <asserts v-model="cases.asserts" :show-btn="false" class="bg-change"></asserts>
                 </el-col>
               </el-row>
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">提取参数</el-col>
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">
                   <extracts v-model="cases.extracts" :edit="false" class="bg-change"></extracts>
                 </el-col>
               </el-row>
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">超时时间</el-col>
                 <template v-if="cases.waitingTime">
                   <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23">
                     {{cases.waitingTime}} s
                   </el-col>
                 </template>
                 <template v-else>
                   <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23">-</el-col>
                 </template>
               </el-row>
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left">重试次数</el-col>
               ...
               <el-row :gutter="10" class="row-class">
                 <el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1" class="test-left" style="height: 40px;line-height: 40px">失败后是否继续</el-col>
                 <el-col :xs="16" :sm="18" :md="20" :lg="19" :xl="23" class="test-right">
...
export default {
  ...
  methods: {
    CaseDetail () {
      let self = this
      this.loading = true
      this.$api.api.getCaseDetail(self.caseId).then(
        (response) => {
          ...
          self.cases.caserelationship.startRunTime = self.cases.caserelationship.startRunTime
            ? self.$moment(self.cases.caserelationship.startRunTime).format('YYYY-MM-DD HH:mm:ss') : null
          self.cases.caserelationship.endRunTime = self.cases.caserelationship.endRunTime
            ? self.$moment(self.cases.caserelationship.endRunTime).format('YYYY-MM-DD HH:mm:ss') : null
          this.loading = false
        }
      ).catch(
        (error) => {
    ...
    execute (data, project) {
      this.$api.api.executeCase(data, project).then((response) => {
      }).catch((error) => {
        console.log(error)
      })
    },
    remove (item) {
      this.$api.api.deleteCase(item).then(
        (response) => {
          this.$message({
            showClose: true,
            message: '删除用例成功',
