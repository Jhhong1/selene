<template>
    <div class="el-bread">
        <el-breadcrumb class="bread" separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ name: 'ApiTestSetDetail', params: { name: name, id: id }, query: $route.query }" class="is-link">
                {{ name }}
            </el-breadcrumb-item>
        ...
        <el-tabs v-model="activeName" style="background-color: white">
            ...
            <el-tab-pane label="测试用例" name="cases">
                <case-record v-model="cases"></case-record>
            </el-tab-pane>
            <el-tab-pane label="前置条件" name="setup">
                <case-record v-model="setUpCases"></case-record>
            </el-tab-pane>
            <el-tab-pane label="后置条件" name="teardown">
                <case-record v-model="teardownCases"></case-record>
            </el-tab-pane>
        </el-tabs>
    </div>
</template>
